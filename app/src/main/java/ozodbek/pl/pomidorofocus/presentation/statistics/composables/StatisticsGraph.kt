...
import ozodbek.pl.pomidorofocus.utils.extensions.toDayOfMonthFormatted
import ozodbek.pl.pomidorofocus.utils.extensions.toReadableWeekday
...
@Preview(locale = "bn")
@Composable
fun StatisticsGraphPreview() = PomidoroFocusAppTheme {
	Surface(
